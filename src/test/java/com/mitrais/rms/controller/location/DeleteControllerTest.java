...
@DataJpaTest
@ComponentScan(basePackageClasses = {DeleteController.class, LocationService.class})
@RunWith(SpringRunner.class)
public class DeleteControllerTest
{
	@Autowired
	@Qualifier("locationDeleteController")
	...
	@Test
	public void itShouldDeleteLocation()
	{
		given().
			standaloneSetup(this.deleteController).
		when().
			delete("/employees/{employeeId}/locations/{locationId}",
